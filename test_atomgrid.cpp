...
int main()
{
    ...
    //原子坐标，grouped 
    part_h2o = chemgrid::grid::get_partition_from_templates(atm_coords, grouped, charges, chemgrid::RadiiAdjustMethod::Treutler, chemgrid::constants::BRAGG_RADII_ANG, chemgrid::BeckeScheme::Original, true);
    ...
    export_grid3_txt("h2o_padding.txt", part_h2o.first, part_h2o.second, quadrature_weights, atm_idx);
    return 0;
}