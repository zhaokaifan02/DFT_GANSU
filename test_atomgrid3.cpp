...
int main()
{
    ...
    //原子坐标，grouped 
    part_h2o = chemgrid::grid::get_partition_from_templates_GPU_nbr2_1kernel(atm_coords, grouped, charges, chemgrid::RadiiAdjustMethod::Treutler, chemgrid::constants::BRAGG_RADII_ANG, chemgrid::BeckeScheme::Original, true);
