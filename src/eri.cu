...
namespace gansu
{
    ...
    void ERI_DFT::precomputation()
    {
        ...
        // {
        //     std::cout << "atom_index: " << shells_ptr->atom_index << std::endl;
        //     std::cout << "basis_index: " << shells_ptr->basis_index << std::endl;
        //     std::cout << "coefficient: " << shells_ptr->coefficient << std::endl;
        //     std::cout << "coordinate: " << shells_ptr->coordinate.x << ", " << shells_ptr->coordinate.y << ", " << shells_ptr->coordinate.z << std::endl;
        //     std::cout << "exponent: " << shells_ptr->exponent << std::endl;
        //     std::cout << "shell_type: " << shells_ptr->shell_type << std::endl;
        //     shells_ptr++;
        //     std::cout << "===========================================================" << std::endl;
        // }
        // create mol
