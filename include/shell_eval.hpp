    ...
    const BuildOptions &opt = {})
{
    ...
    out.reserve(128);
    std::vector<std::string> namess = bs.get_element_name_list();
    for (auto a : namess)
    {
        std::cout << a << std::endl;
    }
...
// struct BuildOptions
// {
//     bool normalize_cart = false;  // 保持 false，不归一化
//     bool fix_p_orbital = true;    // 新增：修正 p 轨道
// };
...
//     case 'I': return 6;
//     case 'J': return 7;
//     default: throw std::runtime_error("Unknown shell type");
//     }
// }
